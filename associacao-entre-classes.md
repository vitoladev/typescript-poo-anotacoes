...
Associação é a relação mais fraca entre os objetos, significa que em alguma parte do código um objeto depende de outro para ter determinada funcionalidade
